...
import {SafeAreaView, Text, StyleSheet, TouchableOpacity, View, TextInput, Keyboard} from 'react-native';
...
export default function Search(){
    ...
    async function hadleSearch(){
        //weather?key=a71f7c5e&city_name=Campinas,SP
         ...
         return(
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.searchBox}>
                    ...
                    <TouchableOpacity style={styles.icon} onPress={hadleSearch}>
                        <Feather 
                         name='search'
                         size={22}
                         color='#fff'
